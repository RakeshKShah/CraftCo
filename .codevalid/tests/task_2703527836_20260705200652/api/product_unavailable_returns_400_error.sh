...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_ID="buyer-unavailable-${CASE_SUFFIX}"
MISSING_PRODUCT_ID="prod-nonexistent-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/product_unavailable_returns_400_error_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/product_unavailable_returns_400_error_${CASE_SUFFIX}.status"
...
[ "$ORDER_COUNT" = '0' ]
echo 'CODEVALID_TEST_ASSERTION_OK:product_unavailable_returns_400_error'
