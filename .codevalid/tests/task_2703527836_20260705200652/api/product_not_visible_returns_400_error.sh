...
SELLER_PROFILE_ID="seller-profile-hidden-${CASE_SUFFIX}"
PRODUCT_ID="prod-hidden-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/product_not_visible_returns_400_error_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/product_not_visible_returns_400_error_${CASE_SUFFIX}.status"
...
INSERT INTO "SellerProfile" (id, "userId", "storeName", bio, status, "createdAt") VALUES
  ('${SELLER_PROFILE_ID}', '${SELLER_USER_ID}', 'Hidden Store ${CASE_SUFFIX}', 'bio', 'ACTIVE', NOW());
INSERT INTO "Product" (id, title, description, price_cents, stock_qty, visible, status, "sellerId", category, "createdAt") VALUES
  ('${PRODUCT_ID}', 'Hidden Product ${CASE_SUFFIX}', 'desc', 1500, 10, false, 'ACTIVE', '${SELLER_PROFILE_ID}', 'general', NOW());
SQL
...
[ "$ORDER_COUNT" = '0' ]
echo 'CODEVALID_TEST_ASSERTION_OK:product_not_visible_returns_400_error'
