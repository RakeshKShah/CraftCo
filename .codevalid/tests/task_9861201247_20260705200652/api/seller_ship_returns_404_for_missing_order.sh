...
CASE_SUFFIX="$(date +%s)-$$"
SELLER_USER_ID="seller-user-missingorder-${CASE_SUFFIX}"
SELLER_PROFILE_ID="seller-profile-missingorder-${CASE_SUFFIX}"
MISSING_ORDER_ID="order-missing-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/seller_ship_returns_404_for_missing_order_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/seller_ship_returns_404_for_missing_order_${CASE_SUFFIX}.status"
...
echo 'CODEVALID_TEST_ASSERTION_OK:seller_ship_returns_404_for_missing_order'
