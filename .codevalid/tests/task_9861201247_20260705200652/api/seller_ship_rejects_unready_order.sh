...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_ID="buyer-unready-${CASE_SUFFIX}"
SELLER_USER_ID="seller-user-unready-${CASE_SUFFIX}"
SELLER_PROFILE_ID="seller-profile-unready-${CASE_SUFFIX}"
PRODUCT_ID="prod-unready-${CASE_SUFFIX}"
ORDER_ID="order-unready-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/seller_ship_rejects_unready_order_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/seller_ship_rejects_unready_order_${CASE_SUFFIX}.status"
...
[ "$DB_STATUS" = 'PENDING' ]
echo 'CODEVALID_TEST_ASSERTION_OK:seller_ship_rejects_unready_order'
