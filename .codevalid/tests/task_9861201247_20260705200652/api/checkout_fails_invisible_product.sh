...
RESPONSE_FILE="/tmp/checkout_fails_invisible_product_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/checkout_fails_invisible_product_${CASE_SUFFIX}.status"
...
INSERT INTO "Product" (id, title, description, price_cents, stock_qty, visible, status, "sellerId", category, "createdAt") VALUES
  ('${PRODUCT_ID}', 'Hidden Product ${CASE_SUFFIX}', 'desc', 1999, 10, false, 'ACTIVE', '${SELLER_PROFILE_ID}', 'general', NOW());
SQL
...
[ "$STOCK_NOW" = '10' ]
echo 'CODEVALID_TEST_ASSERTION_OK:checkout_fails_invisible_product'
