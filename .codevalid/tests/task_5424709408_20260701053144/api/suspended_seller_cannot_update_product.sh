...
SELLER_ID="profile-suspended-${CASE_SUFFIX}"
PRODUCT_ID="prod-suspended-${CASE_SUFFIX}"
EMAIL="seller-suspended-${CASE_SUFFIX}@example.com"
TOKEN_FILE="/tmp/suspended_seller_cannot_update_product_${CASE_SUFFIX}.token"
RESPONSE_FILE="/tmp/suspended_seller_cannot_update_product_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/suspended_seller_cannot_update_product_${CASE_SUFFIX}.status"
cleanup() {
