...
RESPONSE_FILE="/tmp/missing_auth_token_returns_401_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/missing_auth_token_returns_401_${CASE_SUFFIX}.status"
cleanup() {
...
psql "$DATABASE_URL" -c "INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, photos, status, visible) VALUES ('${PRODUCT_ID}', '${SELLER_ID}', 'Unauth Original', 'Unauth description', 'SPORTS', 1800, 9, '[]'::jsonb, 'ACTIVE', true);"
...
echo "CODEVALID_TEST_ASSERTION_OK:missing_auth_token_returns_401"
