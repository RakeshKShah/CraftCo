...
TOKEN_FILE="/tmp/non_seller_role_rejected_${CASE_SUFFIX}.token"
...
psql "$DATABASE_URL" -c "INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, photos, status, visible) VALUES ('${PRODUCT_ID}', '${OWNER_SELLER_ID}', 'Buyer Forbidden Original', 'Original description', 'BOOKS', 999, 11, '[]'::jsonb, 'ACTIVE', true);"
