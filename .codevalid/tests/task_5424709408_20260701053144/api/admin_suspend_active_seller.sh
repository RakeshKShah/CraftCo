...
CASE_SUFFIX="$(date +%s)-$$"
TEST_ID="admin_suspend_active_seller"
...
SELLER_ID="seller-xyz789-${CASE_SUFFIX}"
PRODUCT_ID_1="prod-1-${CASE_SUFFIX}"
PRODUCT_ID_2="prod-2-${CASE_SUFFIX}"
PRODUCT_ID_3="prod-3-${CASE_SUFFIX}"
...
INSERT INTO users (id, email, password_hash, role, status, created_at)
VALUES ('${SELLER_USER_ID}', '${SELLER_EMAIL}', '${HASH}', 'SELLER', 'ACTIVE', NOW());
...
echo "CODEVALID_TEST_ASSERTION_OK:admin_suspend_active_seller"
