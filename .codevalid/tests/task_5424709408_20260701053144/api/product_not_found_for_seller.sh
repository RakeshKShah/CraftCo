...
TOKEN_FILE="/tmp/product_not_found_for_seller_${CASE_SUFFIX}.token"
RESPONSE_FILE="/tmp/product_not_found_for_seller_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/product_not_found_for_seller_${CASE_SUFFIX}.status"
cleanup() {
...
echo "CODEVALID_TEST_ASSERTION_OK:product_not_found_for_seller"
