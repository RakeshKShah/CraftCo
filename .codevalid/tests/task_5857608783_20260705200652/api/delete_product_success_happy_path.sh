...
CASE_SUFFIX="$(date +%s)-$$"
USER_ID="user-seller-1-${CASE_SUFFIX}"
SELLER_ID="seller-1-${CASE_SUFFIX}"
PRODUCT_ID="prod-owned-1-${CASE_SUFFIX}"
USER_EMAIL="seller1-${CASE_SUFFIX}@example.com"
RESPONSE_FILE="/tmp/delete_product_success_happy_path_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/delete_product_success_happy_path_${CASE_SUFFIX}.status"
...
INSERT INTO seller_profiles (id, user_id, store_name, bio) VALUES ('${SELLER_ID}', '${USER_ID}', 'Store ${CASE_SUFFIX}', 'bio');
INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, photos, status, visible)
VALUES ('${PRODUCT_ID}', '${SELLER_ID}', 'Owned Product ${CASE_SUFFIX}', 'owned desc', 'crafts', 1500, 5, '[]'::jsonb, 'ACTIVE', true);
SQL
...
echo "CODEVALID_TEST_ASSERTION_OK:delete_product_success_happy_path"
