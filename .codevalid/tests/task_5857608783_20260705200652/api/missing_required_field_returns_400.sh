...
CASE_SUFFIX="$(date +%s)-$$"
USER_ID="seller-03-${CASE_SUFFIX}"
SELLER_ID="sp-03-${CASE_SUFFIX}"
USER_EMAIL="seller03-${CASE_SUFFIX}@example.com"
PRODUCT_TITLE="Notebook ${CASE_SUFFIX}"
PAYLOAD_FILE="/tmp/missing_required_field_returns_400_${CASE_SUFFIX}.payload.json"
RESPONSE_FILE="/tmp/missing_required_field_returns_400_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/missing_required_field_returns_400_${CASE_SUFFIX}.status"
...
[ "$PRODUCT_COUNT" = "0" ]
echo "CODEVALID_TEST_ASSERTION_OK:missing_required_field_returns_400"
