...
CASE_SUFFIX="$(date +%s)-$$"
USER_ID="seller-pen-${CASE_SUFFIX}"
SELLER_ID="sp-pen-${CASE_SUFFIX}"
USER_EMAIL="sellerpen-${CASE_SUFFIX}@example.com"
PRODUCT_TITLE="Pending Item ${CASE_SUFFIX}"
PAYLOAD_FILE="/tmp/seller_pending_status_cannot_create_${CASE_SUFFIX}.payload.json"
RESPONSE_FILE="/tmp/seller_pending_status_cannot_create_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/seller_pending_status_cannot_create_${CASE_SUFFIX}.status"
...
VALUES ('${USER_ID}', '${USER_EMAIL}', 'hash', 'SELLER', 'PENDING');
INSERT INTO seller_profiles (id, user_id, store_name, bio)
VALUES ('${SELLER_ID}', '${USER_ID}', 'Pending Store ${CASE_SUFFIX}', 'bio');
SQL
...
{
  "title": "${PRODUCT_TITLE}",
  "description": "Pending seller item",
  "category": "CLOTHING",
  "price_cents": 1500,
  "stock_qty": 3,
  "photos": []
...
[ "$PRODUCT_COUNT" = "0" ]
echo "CODEVALID_TEST_ASSERTION_OK:seller_pending_status_cannot_create"
